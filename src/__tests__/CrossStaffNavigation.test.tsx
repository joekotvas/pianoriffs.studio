...
const createMockScore = (): Score => {
    ...
    const createNote = (pitch: string, id: number) => ({ id, pitch, velocity: 80, duration: 'quarter', dotted: false, tied: false });
    ...
    staff0Measures.push(createMeasure([
...
describe('Cross-Staff Navigation (Alt+Arrows)', () => {
    ...
    it('should place cursor at the START of an empty measure even if coming from a later quant', () => {
        ...
        score.staves[0].measures.push({ id: 999, events: [{ id: 'late-event', notes: [{ id: 998, pitch: 'C4', duration: 'quarter' }], duration: 'quarter', dotted: false, tuplet: undefined, isRest: false }], isPickup: false }); // Measure 2, event at 0? No, let's make it start later? 
        ...
        score.staves[0].measures[1] = {
            ...
            isPickup: false,
            events: [
                { id: 'm1-e1', notes: [{id: 1, pitch: 'C4'}], duration: 'quarter', dotted: false, tuplet: undefined, isRest: false }, // 0-24
                { id: 'm1-e2', notes: [{id: 2, pitch: 'C4'}], duration: 'quarter', dotted: false, tuplet: undefined, isRest: false }, // 24-48
            ]
        };
